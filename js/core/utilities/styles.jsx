export let styles = {
    ...
    graph: { position: 'relative', backgroundColor: 'aqua', height: 'calc(100% - 72px' },
    ...
    collapsetabtop: { position: 'absolute', height: '24px', width: '48px', bottom: '1px', right: '10px', backgroundColor: '#cff', zIndex: 1, textAlign: 'center', border: '1px solid gray', cursor: 'pointer', borderRadius: '6px 6px 0 0' },
    collapsetabbottom: { position: 'absolute', height: '24px', width: '48px', top: '-1px', right: '10px', backgroundColor: '#d3f8d3', zIndex: 1, textAlign: 'center', border: '1px solid gray', cursor: 'pointer', borderRadius: '0 0 6px 6px' },
