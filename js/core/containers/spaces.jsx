...
class Spaces extends React.Component {
    ...
    render() {
        ...
        <div style={styles.main}>
            <Splitter primaryPane={<SpaceGraph data={this.state.sampledata}/>} secondaryPane={<Splitter primaryPane={<SpaceList />} secondaryPane={<SpaceItem />} orientation="horizontal" showTabs={true}/>} orientation="horizontal" division={30} collapse={0} threshold={80} showTabs={true} showHandle={true}/>
        </div>
