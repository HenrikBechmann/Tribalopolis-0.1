...
const SplitNavigationMenu = ({ split, changeSplitFrom, classes }) => {
    return <div className={classes.root}>
        <IconButton className={classes.iconbutton} style={{ marginBottom: '5px' } /*margin???*/} onClick={() => changeSplitFrom('horizontal')}>
        ...
        <IconButton className={classes.iconbutton} style={{ marginBottom: '5px' } /*margin???*/} onClick={() => changeSplitFrom('vertical')}>
            <img style={{ transform: 'rotate(90deg)' }} src={(split == 'vertical') ?
        '/public/icons/ic_border_all_black_24px_split_red.svg' :
        '/public/icons/ic_border_all_black_24px_split.svg'}/>
        </IconButton>

        <IconButton className={classes.iconbutton} onClick={() => changeSplitFrom('matrix')}>
            <img src={(split == 'matrix') ?
...
//# sourceMappingURL=splitnavigationmenu.view.jsx.map