export let styles = {
    ...
    filterbox:{backgroundColor:'black',color:'white',position:'absolute',top:'10px',right:'10px',left:'10px'},
    ...
    topframe:{backgroundColor:'red',position:'absolute',top:0,right:0,left:0,bottom:'45%'},
